...
public class IRTModelGPCTest
{
  ...
  public void initObjects () throws Exception {
    ...
    _pcInformation[0] = 0.00961246996877968;
    _pcInformation[1] = 0.180543461071161;
    _pcInformation[2] = 0.0104402622757748;
    ...
    _pcExpectedScore[0] = 0.0134863380173105;
    _pcExpectedScore[1] = 0.489376598995036;
    _pcExpectedScore[2] = 0.985334740152534;

    _pcD1[0][0] = -0.0114633873147139;
    _pcD1[0][1] = -0.415970109145781;
    _pcD1[0][2] = -0.837534529129654;
    _pcD1[1][0] = 0.838536612685286;
    _pcD1[1][1] = 0.434029890854219;
    _pcD1[1][2] = 0.0124654708703462;

    _pcD2[0][0] = -0.00961246996877968;
    _pcD2[0][1] = -0.180543461071161;
    _pcD2[0][2] = -0.0104402622757749;
    _pcD2[1][0] = -0.00961246996877968;
    _pcD2[1][1] = -0.180543461071161;
    _pcD2[1][2] = -0.0104402622757749;

    _Model = new IRTModelGPC (_aParam, _bParamVector, 0D); // Param C, unused considered as 0
  }

...
public class IRTModel3plnTest
{
  ...
  public void initObjects () throws Exception {
    ...
    _pcInformation[0] = 0.000492006607081433;
    _pcInformation[1] = 0.11949762146907;
    _pcInformation[2] = 0.00832742153382223;
    _pcExpectedInformation[0][0] = 0;
    _pcExpectedInformation[0][1] = 0;
    _pcExpectedInformation[1][0] = 0;
    _pcExpectedInformation[1][1] = 0;
    _pcExpectedInformation[2][0] = 0;
    _pcExpectedInformation[2][1] = 0;
    _pcExpectedScore[0] = 0.210789070413848;
    _pcExpectedScore[1] = 0.591501279196029;
    _pcExpectedScore[2] = 0.988267792122027;
    _pcD1[0][0] = -0.0114633873147139;
    _pcD1[0][1] = -0.415970109145781;
    _pcD1[0][2] = -0.837534529129654;
    _pcD1[1][0] = 0.0429198275844623;
    _pcD1[1][1] = 0.287274539303956;
    _pcD1[1][2] = 0.00994277996212988;
    _pcD2[0][0] = -0.00961246996877968;
    _pcD2[0][1] = -0.180543461071161;
    _pcD2[0][2] = -0.0104402622757748;
    _pcD2[1][0] = 0.0336557286327501;
    _pcD2[1][1] = -0.0773385454620783;
    _pcD2[1][2] = -0.00830233897320937;
    _Model = new IRTModel3pln (_aParam, _bParamVector, _cParam);
  }
  ...
  public void test_NoDifficulty_ConstructorThrowsException () throws Exception {
    ...
    IRTModel3pln model = new IRTModel3pln (_aParam, bVector, _cParam);
  }
  ...
  public void test_MorethanOne_bParam_ConstructorThrowsException () throws Exception {
    ...
    bVector.add (0D);
    bVector.add (1D); // Add more than 1 b values
    IRTModel3pln model = new IRTModel3pln (_aParam, bVector, _cParam);
  }
}
